        ...
        <el-form ref="importForm">
            ...
            <el-form-item label="" prop="fileName">
                ...
                <label for="dictUpload" class="up__speech">
                    ...
                    <span class="up__speech-txt">选择上传文件<i>支持xls、xlsx文件，单个文件不得大于2M</i></span>
                </label>
...
<script>
    import {addBatch,queryTask,exportKnow} from '@/api/brainkb.js'
    ...
    export default {
        ...
        methods : {
            ...
            importBatch : function(){
                ...
                formData.append("dicId", _this.dicId);
                formData.append("file", file);
                addBatch(formData).then(function(data){
                    if(data.code == 0){
